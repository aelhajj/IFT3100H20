  ...
  float&  x,  float& y, float&  z)
{
  ...
  x = 0.5 * ((-t + 2 * tt - ttt) * p1x + (2 - 5 * tt + 3 * ttt) * p2x + (t + 4 * tt - 3 * ttt) * p3x + (-tt + ttt) * p4x);
  y = 0.5 * ((-t + 2 * tt - ttt) * p1y + (2 - 5 * tt + 3 * ttt) * p2y + (t + 4 * tt - 3 * ttt) * p3y + (-tt + ttt) * p4y);
  z = 0.5 * ((-t + 2 * tt - ttt) * p1z + (2 - 5 * tt + 3 * ttt) * p2z + (t + 4 * tt - 3 * ttt) * p3z + (-tt + ttt) * p4z);
}
